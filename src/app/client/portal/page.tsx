    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#F7F7F2] p-8 text-center">
        ...
        <div className="bg-white p-16 rounded-[4rem] shadow-2xl border border-neutral-100 max-w-md w-full">
          ...
          <Button asChild className="w-full rounded-full py-2.5 bg-neutral-900 text-white font-sans font-black uppercase tracking-[0.18em] text-[0.65rem] md:text-[0.7rem] lg:text-[0.75rem]">
    ...
    <div className="min-h-screen bg-[#F7F7F2] pt-32 pb-32 px-6">
      ...
      <div className="max-w-7xl mx-auto space-y-20">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
          ...
          <Button asChild className="rounded-full px-6 py-2.5 bg-neutral-900 text-white font-sans font-black uppercase tracking-[0.18em] text-[0.65rem] md:text-[0.7rem] lg:text-[0.75rem] shadow-2xl shadow-neutral-900/10">
                    ...
                    <div className="flex flex-col md:flex-row">
                      ...
                      <div className="p-12 flex-1 flex flex-col justify-between">
                        ...
                        <div className="flex flex-wrap gap-4 mt-12">
                          <Button variant="outline" className="rounded-full px-6 py-2.5 border-neutral-200 text-[0.65rem] md:text-[0.7rem] lg:text-[0.75rem] font-sans font-black uppercase tracking-[0.18em] hover:bg-neutral-900 hover:text-white transition-all">Gérer le rendez-vous</Button>
                        </div>
                      </div>
                    </div>
                  </Card>
                  ...
                  return (
                    <div key={apt.id} className="bg-white border-none shadow-sm rounded-[3rem] p-10 flex flex-col md:flex-row items-center justify-between gap-10 transition-all duration-500 hover:shadow-xl">
                      ...
                      <div className="flex items-center gap-12">
                        ...
                        <Button variant="ghost" className="rounded-full px-6 py-2.5 bg-neutral-50 hover:bg-neutral-900 hover:text-white transition-all text-[0.65rem] md:text-[0.7rem] lg:text-[0.75rem] font-sans font-black uppercase tracking-[0.18em] flex items-center gap-3">

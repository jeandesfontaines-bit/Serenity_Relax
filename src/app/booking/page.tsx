    ...
    <div className="min-h-screen bg-background pt-24 md:pt-32 pb-24 px-6">
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-12 md:mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-serif font-medium text-primary mb-6 tracking-tighter leading-tight">
            Réserver un <span className="italic">moment.</span>
          </h1>
          <p className="text-muted-foreground text-base md:text-lg font-light max-w-lg mx-auto leading-relaxed italic font-serif">

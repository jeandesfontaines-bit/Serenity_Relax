    ...
    <div className="min-h-screen bg-background py-32 px-4">
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-headline font-light text-primary mb-6 italic">Reserve Your Silence</h1>
          <p className="text-muted-foreground text-base font-light max-w-lg mx-auto leading-relaxed">
            Curate your personal journey of recovery. Choose your therapy and secure your preferred time in our sanctuary.
          </p>
        </header>

        <div className="bg-white p-1 shadow-2xl rounded-[3rem]">

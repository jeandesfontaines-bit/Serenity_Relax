    ...
    <div className="max-w-7xl mx-auto space-y-12 pb-32">
      ...
      >
        ...
        <div className="space-y-6 relative z-10">
           ...
           <h1 className="title-luxe text-5xl md:text-7xl leading-none">{client.name} <br/><span className="italic font-sans opacity-40 text-[#F8F5F0]">Bio-Dossier.</span></h1>
        ...
        <div className="flex flex-col gap-4 text-right relative z-10">
           <p className="text-xl font-sans italic text-gray-300">Inscrit le {client.joinedAt || '20/03/2026'}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8 flex flex-col gap-10">
           <section className="dash-card p-12 bg-white border border-white space-y-10 shadow-2xl shadow-indigo-100/10">
              <div className="flex justify-between items-center">
                 <h2 className="text-3xl font-sans font-medium flex items-center gap-4 text-[#222F3E]">
              ...
              <textarea
                ...
                className="w-full min-h-[600px] bg-gray-50/50 rounded-[2.5rem] p-10 font-sans italic text-xl text-[#222F3E] leading-relaxed focus:outline-none focus:ring-4 focus:ring-indigo-50 transition-all border border-transparent hover:border-indigo-100"
              />
           </section>
        </div>
        ...
        <div className="lg:col-span-4 space-y-10">
           <section className="dash-card p-10 bg-[#222F3E] text-white space-y-10 relative overflow-hidden group">
              <h3 className="text-xl font-sans font-medium flex items-center gap-4 text-[#0ABDE3]">
              ...
              <div className="space-y-6">
                 <div>
                    ...
                    <p className="text-lg font-sans italic">{client.healthInfo || 'Aucune contre-indication signalée.'}</p>
                 </div>
                 <div className="pt-6 border-t border-white/10">
                    <p className="text-[0.6rem] font-black uppercase tracking-widest text-gray-400 mb-2">Dernière séance</p>
                    <p className="text-lg font-sans italic">13 Avril 2026 • Massage Sensoriel</p>
                 </div>
              </div>
           </section>

           <section className="dash-card p-10 bg-white border border-white space-y-10">
              <h3 className="text-xl font-sans font-medium flex items-center gap-4 text-[#5F27CD]">
           ...
           <div className="px-10 py-10 bg-indigo-50/50 border border-indigo-100/50 rounded-[3rem] space-y-6">
              <div className="flex items-center gap-4 text-[#5F27CD]">
                 <Phone size={18} />
                 <p className="text-sm font-bold font-sans italic">{client.phoneNumber || '+41 XX XXX XX XX'}</p>
              </div>
              <div className="flex items-center gap-4 text-[#5F27CD]">
                 <Mail size={18} />
                 <p className="text-sm font-bold font-sans italic">{client.email}</p>
              </div>
           </div>
        </div>

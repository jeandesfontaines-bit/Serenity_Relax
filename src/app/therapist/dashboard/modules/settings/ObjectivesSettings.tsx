    ...
    <div className="space-y-3">
      ...
      <div className="rounded-xl p-6 border shadow-sm text-center relative overflow-hidden group" style={{ background: 'hsl(var(--background))', borderColor: 'hsl(var(--border))' }}>
        ...
        <div className="relative z-10 max-w-[260px] mx-auto space-y-2">
          <label className="text-[7.5px] font-bold uppercase tracking-[0.4em] leading-none block" style={{ color: 'hsl(var(--muted-foreground))' }}>CHIFFRE D'AFFAIRE MENSUEL CIBLE</label>
          <div className="relative inline-block group/input">
            ...
            />
            <p className="mt-0 text-[7px] font-bold uppercase tracking-[0.3em] opacity-30" style={{ color: 'hsl(var(--foreground))' }}>FRANCS SUISSES / MOIS</p>
          ...
          <p className="text-[9px] font-bold leading-normal max-w-[180px] mx-auto uppercase tracking-widest" style={{ color: 'hsl(var(--muted-foreground))' }}>

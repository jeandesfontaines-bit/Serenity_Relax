    ...
    <div className="space-y-3">
      ...
      <div className="rounded-xl p-4 border shadow-sm space-y-4 relative overflow-hidden" style={{ background: 'hsl(var(--background))', borderColor: 'hsl(var(--border))' }}>
        <div className="flex items-center justify-between relative z-10">
          <div>
            <h4 className="text-[9.5px] font-bold tracking-[0.05em]" style={{ color: 'hsl(var(--foreground))' }}>Module d'expédition</h4>
            <p className="text-[7px] font-bold tracking-[0.05em] mt-0.5" style={{ color: 'hsl(var(--muted-foreground))' }}>Statut : {enabled ? 'Activé' : 'Désactivé'}</p>
          </div>
        ...
        <div className={`space-y-3 transition-all duration-700 ${enabled ? 'opacity-100' : 'opacity-30 blur-sm pointer-events-none translate-y-2'}`}>
          <div className="space-y-1.5">
            <label className="text-[7px] font-bold tracking-[0.05em] px-1" style={{ color: 'hsl(var(--muted-foreground))' }}>Corps du message type</label>
          ...
          <div className="flex items-start gap-2 p-3 rounded-xl shadow-lg" style={{ background: 'hsl(var(--primary))', color: 'hsl(var(--primary-foreground))' }}>
            ...
            <p className="text-[9px] font-bold leading-normal opacity-70 tracking-[0.05em]">Le système injectera automatiquement votre charte graphique Serenity.</p>
          </div>
        </div>
      </div>
    </div>

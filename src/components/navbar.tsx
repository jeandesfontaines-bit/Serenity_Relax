    ...
    <nav className="absolute top-0 left-0 right-0 z-[100] px-6 py-4 md:py-6 bg-transparent">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <Link href="/" className="flex items-baseline gap-1 md:gap-2 cursor-pointer group">
          ...
          <span className="font-cursive text-[10px] md:text-xs lg:text-sm text-neutral-900 tracking-normal whitespace-nowrap normal-case transition-colors ml-1">by João</span>
        </Link>

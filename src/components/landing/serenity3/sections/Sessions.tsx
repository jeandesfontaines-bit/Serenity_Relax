...
import { SERVICES } from "@/components/landing/serenity3/data";
...
export default function Sessions({ variant = "default" }: { variant?: LandingVariant }) {
  ...
  return (
    <section id="sessions" className="landing-section" style={{ backgroundColor: "rgba(255, 255, 255, 0.85)" }}>
              ...
              <article key={service.id} className="flex h-full w-full max-w-[31rem] min-[560px]:max-w-[20rem] lg:max-w-[240px]">
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-4 max-[559px]:p-3">
                    ...
                    <h3
                      className="text-[0.95rem] leading-[1.2] font-serif tracking-normal landing-text-high display-tight transition-colors duration-500 group-hover:text-[var(--landing-warm-hover)] max-[559px]:text-[0.95rem]"
                      title={service.name}
                    >
